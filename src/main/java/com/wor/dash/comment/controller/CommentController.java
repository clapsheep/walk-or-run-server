...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse> updateChallenge(@PathVariable("challengeId") int challengeId, @PathVariable("commentId") int commentId, @RequestBody Comment comment) {
        try {
    ...
    public ResponseEntity<ApiResponse> deleteChallenge(@PathVariable("challengeId") int challengeId, @PathVariable("commentId") int commentId) {
        try {
