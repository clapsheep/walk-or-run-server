    ...
    public ResponseEntity<?> register(
        ...
        try {
            ...
            if (response.getAccessToken() != null)
                return new ResponseEntity<ApiResponse>(new ApiResponse("success", "register", 201), HttpStatus.CREATED);
            else
                return new ResponseEntity<ApiResponse>(new ApiResponse("User Already Exists", "register", 400), HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
    ...
    public ResponseEntity<?> login(
        ...
        try {
            ...
            if (response.getAccessToken() != null) return ResponseEntity.ok(response);
                ...
                return new ResponseEntity<ApiResponse>(new ApiResponse("withdrawn user", "login", 403), HttpStatus.UNAUTHORIZED);
        } catch (Exception e) {
