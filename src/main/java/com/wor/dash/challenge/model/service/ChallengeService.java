...
public interface ChallengeService {
    ...
    void addDailyChallenge(Challenge challenge);

    void endChallenges(String endTime);

    void addWeeklyChallenge(Challenge challenge);

    void addMonthChallenge(Challenge challenge);
}
